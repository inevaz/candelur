...
const Contacto = () => {
  return (
    <div className="px-[15dvh] py-10 flex w-full flex-col gap-8">
      <div className="flex w-full items-center justify-between gap-6">
        <div className="w-full flex flex-col text-justify gap-6">
          <h1 className="font-krub font-bold text-3xl">Formulario de contacto</h1>
          <ContactForm />
        </div>
        <div className="w-full h-full flex flex-col text-justify justify-between gap-6">
          ...
          <div className="h-full gap-2 flex flex-col justify-between">
            <p className="font-krub">Av. Cachimba del Rey 396 - Maldonado</p>
            <iframe
